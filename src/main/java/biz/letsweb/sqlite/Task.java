...
public class Task {
  ...
  public void stopKeepingTime() throws ApplicationException {
    if (this.isKeepingTime) {
      ...
      throw new ApplicationException(
          "Cannot stop keeping time when it hasn't been started beforehand.");
    }
  }
  ...
  public String toString() {
    ...
    String sep = "|";
    builder.append(projectId).append(sep).append(name).append(sep).append(isFocused).append(sep)
        .append(isKeepingTime).append(sep).append(startTime).append(sep).append(stopTime)
        .append(sep).append(description);
